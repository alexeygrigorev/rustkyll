...
jekyll-docs/docs (228 pages) builds with Jekyll in 3.0s but fails with rustkyll.
...
1. Run `cargo run --release -- build --source websites/jekyll-docs/docs` and capture the error
...
- Output page count matches Jekyll's (close to 228 pages)
